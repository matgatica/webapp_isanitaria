...
tabs=dbc.Tabs(
    [
        ...
        dbc.Tab([
            html.Br(),
            html.Iframe(style={"width":"1500px", "height":"1000px","frameborder":"5","allowFullScreen":"true"}, src="https://app.powerbi.com/view?r=eyJrIjoiODgwZTA1MGEtMmY4ZS00MTk3LWI5NDYtMDI2YjEyNTY3MWFjIiwidCI6IjU2NTgyYjllLTg4MjQtNDlkMC1hNjY1LWNkMzI4YzBlMDA0YSIsImMiOjR9&pageName=ReportSection014ade1a435ca5b5fd7e"),
            ],
...
layout = html.Div([sidebar, cuerpo,html.Footer(
    children=[
        dbc.Row([
