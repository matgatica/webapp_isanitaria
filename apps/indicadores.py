...
def update_geograph_5(value_ind):
    ...
    fig6 = px.scatter_mapbox(dff,lat=dff.lat,lon=dff.lng,hover_name=dff["Comuna"],size='Indicador 5',color='Indicador 5',hover_data=["SE"],width=1500,height=1000,template='plotly_dark')
...
def update_geograph_6(value_ind):
    ...
    fig6 = px.scatter_mapbox(dff,lat=dff.lat,lon=dff.lng,hover_name=dff["Comuna"],size='Indicador 6',color='Indicador 6',hover_data=["SE"],width=1500,height=1000,template='plotly_dark')
    fig6.update_layout(mapbox_style="open-street-map")
    fig6.update_geos(fitbounds="locations")
    fig6.update_geos(
        visible=False, resolution=110,
...
def update_geograph_7(value_ind):
    ...
    fig7 = px.scatter_mapbox(dff,lat=dff.lat,lon=dff.lng,hover_name=dff["Comuna"],size='Indicador 7',color='Indicador 7',hover_data=["SE"],width=1500,height=1000,template='plotly_dark')
    fig7.update_layout(mapbox_style="open-street-map")
    fig7.update_geos(fitbounds="locations")
    fig7.update_geos(
        visible=False, resolution=110,
        showcountries=True, countrycolor="Black",
        scope="south america",
    ...
    fig7.update_layout(margin={'l': 0, 'b': 0, 't': 0, 'r': 0}, hovermode='closest')
